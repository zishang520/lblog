...
<div id="page-wrapper">
    ...
    <div class="row">
        <form action="{{ url('/admin/page') }}" method="post" id="addpage" name="addpage">
            <div class="col-lg-8">
                <div class="panel panel-default">
                    <div class="panel-heading">新建页面</div>
                    <div class="panel-body">
                        <div id="post" class="form-group">
                            <div class="form-group">
                                <label>页面标题：</label>
                                <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control" placeholder="页面标题" />
                            </div>
                            <div class="form-group">
                                <label>页面内容：</label>
            ...
            <div class="col-lg-4 container-side">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <input type="checkbox" value="1" name="allow_remark" id="allow_remark"@if(old('allow_remark') == 1) checked="checked"@endif />
                ...
                <div id="post_button">
                    ...
                    <input type="submit" value="发布页面" class="btn btn-primary" />
